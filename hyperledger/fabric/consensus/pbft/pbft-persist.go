...
func (instance *pbftCore) persistRequestBatch(digest string) {
	//1、从reqBatchStore取出requestBatch,然后采用
...
//从持久化的地方将pqSet、reqBatch、chkpt取出来，并追加到pbftCore的pset、qset、reqBatchStore、chkpts中
func (instance *pbftCore) restoreState() {
	//将pbftCore.view和pbftCore.seqNo 修改为set中最大的视图和最大的序号
